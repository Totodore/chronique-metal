...
<html>
    ...
    <body>
            ...
            <main id="main">
                ...
                <article id="article">
                    ...
                    <div id="text_welcome_article">
                        <p>
                            Ce site est la continuité de la page <a href="https://www.facebook.com/ChroniqueMetal/" target="_blank">Facebook</a> du même nom (et aussi celle de l'ancien site). Vous y trouverez toutes les chroniques publiées depuis sa création et toutes les vidéos présentes sur notre chaîne. En navigant sur ce site vous trouverez aussi des news, des interviews, des reports de concerts, une webradio où je travaille : <a href="http://www.radiometalsound.fr/" target="_blank">Radio Metal Sound</a> ... 
                        </p>
                        <p>
                        ...
                        ?> 
                            <a href="<?php echo $link ?>" class="news_el">
                                <div style="display: flex">
                                    <?php echo $icon ?>
                                    <h3 class="news_title"><?php echo $element['titre']?></h3>
                                </div>
                                <p class="news_meta">
                                    <?php 
        ...
        <?php if (isset($_GET['notif']) AND $_GET['notif'] == 'true') { //si on demande d'activer l'option ca l'affiche?>
            $(function() {
                openModalNotif();
            });  
        <?php } else if (isset($_GET['notif']) AND $_GET['notif'] == 'false') { ?>  //si on demande de virer l'option
            $(function() {
                openUnsubModal();
            });
        <?php } else if(!isset($_COOKIE['notif'])) { ?> //si rien n'est demande mais que ya pas de notifs set on propose...
            $(function() {
                openNotif();
            })
        <?php } ?>
